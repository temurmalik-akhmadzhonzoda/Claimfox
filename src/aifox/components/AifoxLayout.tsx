...
import AifoxNav from '@/aifox/components/AifoxNav'
import CalendarWidget from '@/brokerfox/components/CalendarWidget'
import { useTenantContext } from '@/brokerfox/hooks/useTenantContext'
import { listCalendarEvents } from '@/aifox/api/aifoxApi'
...
export default function AifoxLayout({ title, subtitle, topLeft, children }: AifoxLayoutProps) {
