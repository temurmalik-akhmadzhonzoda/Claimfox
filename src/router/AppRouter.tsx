...
import HeadOfClaimsMgaRolePage from '@/pages/HeadOfClaimsMgaRolePage'
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute><FullscreenBgLayout showHeader /></ProtectedRoute>}>
        ...
        <Route path="/inside-insurfox/roles/data-governance-lead" element={<DataGovernanceLeadRolePage />} />
