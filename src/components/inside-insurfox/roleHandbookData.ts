...
const roles: RoleHandbookRole[] = [
  ...
  { name: 'Product Owner', category: 'platform', tenantLevel: 'Platform', modules: ['Brokerfox', 'Claimsfox', 'Fleetfox', 'Partnerfox', 'AI Fox'], decisionAuthority: 'Roadmap and functional release scope decisions.', aiInteraction: 'consume', slug: 'product-owner' },
