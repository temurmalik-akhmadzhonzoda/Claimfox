...
export default function FinanceClaimsPage() {
  ...
  const copy = lang === 'en'
    ? {
        ...
        subtitle: 'Reserving discipline and payment control for claims finance.',
        lastUpdated: 'Last updated: 27 Jan 2026, 15:12',
        kpi: {
        ...
        audit: {
          ...
          indicators: ['Mandatory sign-offs completed', 'Override reason present', 'Reserve scope confirmed']
        },
        footer: {
    ...
    : {
        title: 'Claims Finance — Finance Dashboard',
        subtitle: 'Reserving-Disziplin und Payment-Control im Claims-Finance.',
        lastUpdated: 'Zuletzt aktualisiert: 27. Jan 2026, 15:12',
        kpi: {
        ...
        audit: {
          ...
          indicators: ['Mandatory Sign-offs abgeschlossen', 'Override-Begründung vorhanden', 'Reserve-Scope bestätigt']
        },
        footer: {
  ...
  const cases: FinanceCase[] = [
    {
      id: 'CFN-601',
      type: 'Reserve',
      trigger: 'Reserve increase requested',
      severity: 'Medium',
      slaDue: '2026-01-27T16:30:00Z',
      slaBucket: 'due_today',
      recommendation: 'Approve reserve',
      status: 'In review',
      applicableRules: ['Reserving Policy v3.4', 'Claims Finance SOP'],
      keyRisks: ['Reserve adequacy', 'Capital impact'],
      evidenceQuality: 82,
      escalationRequired: false,
      summary: 'Reserve increase requested based on loss development.'
    },
    {
      id: 'CFN-608',
      type: 'Payment',
      trigger: 'Payment control check',
      severity: 'Low',
      slaDue: '2026-01-28T12:10:00Z',
      slaBucket: 'due_48h',
      recommendation: 'Adjust reserve',
      status: 'Open',
      applicableRules: ['Payment Controls v2.2'],
      keyRisks: ['Payment timing'],
      evidenceQuality: 88,
      escalationRequired: false,
      summary: 'Payment request aligns with reserve but requires adjustment.'
    },
    {
      id: 'CFN-614',
      type: 'Reserve',
      trigger: 'Reserve override',
      severity: 'High',
      slaDue: '2026-01-27T09:50:00Z',
      slaBucket: 'breached',
      recommendation: 'Hold payment',
      status: 'Breached',
      applicableRules: ['Reserving Policy v3.4', 'Override Protocol'],
      keyRisks: ['Override without rationale', 'Audit risk'],
      evidenceQuality: 61,
      escalationRequired: true,
      summary: 'Override requested without sufficient rationale.'
    }
  ]

  const logs: LogEntry[] = [
    { timestamp: '2026-01-27 10:12', role: 'Claims Finance', action: 'Reserve review', ruleVersion: 'v3.4', evidenceStatus: 'ok', note: 'Approved adjustment' },
    { timestamp: '2026-01-27 09:05', role: 'Claims Finance', action: 'Payment check', ruleVersion: 'v2.2', evidenceStatus: 'ok', note: 'Hold pending' },
    { timestamp: '2026-01-26 17:30', role: 'Finance Controller', action: 'Escalation flagged', ruleVersion: 'v3.4', evidenceStatus: 'stale', note: 'Override review' },
    { timestamp: '2026-01-26 13:10', role: 'Claims Finance', action: 'Evidence request', ruleVersion: 'v3.4', evidenceStatus: 'missing', note: 'Reserve memo' },
    { timestamp: '2026-01-25 16:25', role: 'Compliance', action: 'Audit check', ruleVersion: 'v2.2', evidenceStatus: 'ok', note: 'No issues' }
  ]
    ...
    <section className="uw-page">
      ...
      <div className="uw-container">
        <div className="uw-grid uw-kpi">
          ...
          <Card title={copy.kpi.reserve} variant="glass" className="uw-card"><div className="uw-card-body"><strong>{kpis.reserve}</strong></div></Card>
        </div>

        <div className="uw-grid uw-split">
          <Card title={copy.table.title} variant="glass" className="uw-card" style={{ overflowX: 'auto' }}>
            <table className="uw-table" aria-label="Claims finance decision inbox">
              <thead>
                <tr>
                  <th>{copy.table.id}</th>
            ...
            <div className="uw-card-body" style={{ gap: '0.75rem' }}>
              ...
              <div>
                ...
                <div className="uw-actions">
                  ...
                  <Button onClick={() => {}}>{copy.actions.hold}</Button>
                </div>
              </div>
            </div>
          </Card>
        ...
        <div className="uw-grid uw-triplet">
          ...
          <Card title={copy.audit.title} variant="glass" className="uw-card">
            ...
            <div style={{ overflowX: 'auto' }}>
              <table className="uw-table" aria-label="Claims finance audit log">
                <thead>
                  <tr>
