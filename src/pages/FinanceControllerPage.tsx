...
export default function FinanceControllerPage() {
  ...
  const copy = lang === 'en'
    ? {
        ...
        lastUpdated: 'Last updated: 27 Jan 2026, 15:18',
        kpi: {
          open: 'Open control items',
          dueToday: 'Decisions due today',
          breaches: 'SLA breaches',
          cycle: 'Avg close cycle',
        ...
        audit: {
          ...
          indicators: ['Mandatory sign-offs completed', 'Override reason present', 'Close scope confirmed']
        },
        footer: {
    ...
    : {
        ...
        lastUpdated: 'Zuletzt aktualisiert: 27. Jan 2026, 15:18',
        kpi: {
          open: 'Offene Kontroll-Items',
          dueToday: 'Entscheidungen heute fällig',
          breaches: 'SLA Breaches',
          cycle: 'Ø Close-Zyklus',
        ...
        audit: {
          ...
          indicators: ['Mandatory Sign-offs abgeschlossen', 'Override-Begründung vorhanden', 'Close-Scope bestätigt']
        },
        footer: {
  ...
  const cases: FinanceCase[] = [
    {
      id: 'FC-801',
      type: 'Close',
      trigger: 'Month-end reconciliation',
      severity: 'Medium',
      slaDue: '2026-01-27T16:40:00Z',
      slaBucket: 'due_today',
      recommendation: 'Approve close item',
      status: 'In review',
      applicableRules: ['Close Policy v4.0', 'GL Integrity SOP'],
      keyRisks: ['Reporting delay', 'GL mismatch'],
      evidenceQuality: 84,
      escalationRequired: false,
      summary: 'Reconciliation variance within tolerance.'
    },
    {
      id: 'FC-809',
      type: 'GL',
      trigger: 'GL adjustment request',
      severity: 'Low',
      slaDue: '2026-01-28T12:40:00Z',
      slaBucket: 'due_48h',
      recommendation: 'Adjust GL entry',
      status: 'Open',
      applicableRules: ['GL Policy v3.2'],
      keyRisks: ['Classification accuracy'],
      evidenceQuality: 90,
      escalationRequired: false,
      summary: 'Minor reclassification requested.'
    },
    {
      id: 'FC-814',
      type: 'Reporting',
      trigger: 'Late reporting pack',
      severity: 'High',
      slaDue: '2026-01-27T10:05:00Z',
      slaBucket: 'breached',
      recommendation: 'Escalate to CFO',
      status: 'Breached',
      applicableRules: ['Reporting SOP v2.1', 'Close Policy v4.0'],
      keyRisks: ['Regulatory timing', 'Governance breach'],
      evidenceQuality: 60,
      escalationRequired: true,
      summary: 'Reporting pack delayed; escalation required.'
    }
  ]

  const logs: LogEntry[] = [
    { timestamp: '2026-01-27 10:30', role: 'Finance Controller', action: 'Close review', ruleVersion: 'v4.0', evidenceStatus: 'ok', note: 'Reconciliation complete' },
    { timestamp: '2026-01-27 09:12', role: 'Finance Controller', action: 'GL check', ruleVersion: 'v3.2', evidenceStatus: 'ok', note: 'Adjustment approved' },
    { timestamp: '2026-01-26 17:55', role: 'CFO', action: 'Escalation flagged', ruleVersion: 'v2.1', evidenceStatus: 'stale', note: 'Reporting delay' },
    { timestamp: '2026-01-26 12:40', role: 'Finance Controller', action: 'Evidence request', ruleVersion: 'v4.0', evidenceStatus: 'missing', note: 'Reporting pack' },
    { timestamp: '2026-01-25 16:35', role: 'Compliance', action: 'Audit check', ruleVersion: 'v3.2', evidenceStatus: 'ok', note: 'No issues' }
  ]
      ...
      <div className="uw-container">
        ...
        <div className="uw-grid uw-split">
          <Card title={copy.table.title} variant="glass" className="uw-card" style={{ overflowX: 'auto' }}>
            <table className="uw-table" aria-label="Finance controller decision inbox">
              <thead>
                <tr>
                  <th>{copy.table.id}</th>
        ...
        <div className="uw-grid uw-triplet">
          ...
          <Card title={copy.audit.title} variant="glass" className="uw-card">
            ...
            <div style={{ overflowX: 'auto' }}>
              <table className="uw-table" aria-label="Finance controller audit log">
                <thead>
                  <tr>
