...
export default function FinancePremiumBillingOpsPage() {
  ...
  const copy = lang === 'en'
    ? {
        ...
        kpi: {
          open: 'Open receivable cases',
          dueToday: 'Decisions due today',
          breaches: 'SLA breaches',
          cycle: 'Avg resolution cycle',
        ...
        actions: {
          approve: 'Approve billing action',
          adjust: 'Adjust invoice',
          escalate: 'Escalate to Finance Controller'
        },
        slaPanel: {
        ...
        audit: {
          ...
          indicators: ['Mandatory sign-offs completed', 'Override reason present', 'Billing scope confirmed']
        },
        footer: {
    ...
    : {
        ...
        kpi: {
          open: 'Offene Receivable Cases',
          dueToday: 'Entscheidungen heute fällig',
          breaches: 'SLA Breaches',
          cycle: 'Ø Lösungszyklus',
          escalations: 'Eskalationen pending',
          collections: 'Collections Erfolg %'
        },
        table: {
          title: 'Decision Inbox',
          id: 'Case ID',
        ...
        snapshot: {
          title: 'Decision Snapshot',
          summary: 'Receivable Summary',
          risks: 'Billing-Risiken',
          rules: 'Anwendbare Policies',
          aiTitle: 'AI-Decision-Template — Human Validation erforderlich',
          templates: 'Entscheidungsvorlagen'
        },
        actions: {
          approve: 'Billing-Aktion freigeben',
          adjust: 'Rechnung anpassen',
          escalate: 'An Finance Controller eskalieren'
        },
        slaPanel: {
          title: 'SLA & Governance',
          buckets: 'SLA Buckets',
        ...
        audit: {
          ...
          indicators: ['Mandatory Sign-offs abgeschlossen', 'Override-Begründung vorhanden', 'Billing-Scope bestätigt']
        },
        footer: {
  ...
  const cases: FinanceCase[] = [
    {
      ...
      severity: 'Medium',
      slaDue: '2026-01-27T16:20:00Z',
      slaBucket: 'due_today',
      recommendation: 'Approve billing action',
      status: 'In review',
      applicableRules: ['Billing Policy v2.1', 'Collections SOP v1.8'],
      keyRisks: ['Cash flow delay', 'Collection escalation'],
      evidenceQuality: 80,
      escalationRequired: false,
      summary: 'Invoice overdue by 18 days; collection step pending.'
    },
    {
      id: 'PB-427',
      type: 'Billing',
      trigger: 'Premium adjustment request',
      severity: 'Low',
      slaDue: '2026-01-28T11:40:00Z',
      slaBucket: 'due_48h',
      recommendation: 'Adjust invoice',
      status: 'Open',
      applicableRules: ['Premium Adjustment Policy v3.0'],
      keyRisks: ['Documentation completeness'],
      evidenceQuality: 86,
      escalationRequired: false,
      summary: 'Premium adjustment requested for mid-term endorsement.'
    },
    {
      id: 'PB-433',
      type: 'Receivable',
      trigger: 'Disputed billing line',
      severity: 'High',
      slaDue: '2026-01-27T09:45:00Z',
      slaBucket: 'breached',
      recommendation: 'Escalate to Finance Controller',
      status: 'Breached',
      applicableRules: ['Dispute Resolution v1.4', 'Collections SOP v1.8'],
      keyRisks: ['Revenue recognition risk', 'Customer escalation'],
      evidenceQuality: 62,
      escalationRequired: true,
      summary: 'Billing line disputed; controller review required.'
    }
  ]

  const logs: LogEntry[] = [
    { timestamp: '2026-01-27 09:40', role: 'Billing Ops', action: 'Receivable review', ruleVersion: 'v2.1', evidenceStatus: 'ok', note: 'Collection step approved' },
    { timestamp: '2026-01-27 08:50', role: 'Billing Ops', action: 'Adjustment check', ruleVersion: 'v3.0', evidenceStatus: 'ok', note: 'Endorsement verified' },
    { timestamp: '2026-01-26 17:22', role: 'Finance Controller', action: 'Escalation flagged', ruleVersion: 'v1.4', evidenceStatus: 'stale', note: 'Dispute pending' },
    { timestamp: '2026-01-26 12:55', role: 'Billing Ops', action: 'Evidence request', ruleVersion: 'v3.0', evidenceStatus: 'missing', note: 'Broker confirmation' },
    { timestamp: '2026-01-25 16:30', role: 'Compliance', action: 'Audit check', ruleVersion: 'v2.1', evidenceStatus: 'ok', note: 'No issues' }
  ]
    ...
    <section className="uw-page">
      ...
      <div className="uw-container">
        <div className="uw-grid uw-kpi">
          ...
          <Card title={copy.kpi.collections} variant="glass" className="uw-card"><div className="uw-card-body"><strong>{kpis.collections}</strong></div></Card>
        </div>

        <div className="uw-grid uw-split">
          <Card title={copy.table.title} variant="glass" className="uw-card" style={{ overflowX: 'auto' }}>
            <table className="uw-table" aria-label="Premium billing decision inbox">
              <thead>
                <tr>
                  <th>{copy.table.id}</th>
        ...
        <div className="uw-grid uw-triplet">
          ...
          <Card title={copy.audit.title} variant="glass" className="uw-card">
            ...
            <div style={{ overflowX: 'auto' }}>
              <table className="uw-table" aria-label="Premium billing audit log">
                <thead>
                  <tr>
