...
function roleText(value: string, lang: 'de' | 'en') {
  ...
  const sentenceMap: Record<string, string> = {
    'Owns strategic platform direction and module portfolio alignment.': 'Verantwortet die strategische Plattformausrichtung und die Abstimmung des Modulportfolios.',
    'Owns architecture, cloud strategy, and technical platform governance.': 'Verantwortet Architektur, Cloud-Strategie und technische Plattform-Governance.',
    'System-wide authorization and break-glass approval.': 'Systemweite Autorisierung und Freigabe für Break-Glass-Szenarien.',
    'Leads engineering delivery capability across platform domains.': 'Leitet die Engineering-Delivery-Fähigkeit über alle Plattformdomänen.',
    'Owns target architecture and integration standards across modules.': 'Verantwortet Zielarchitektur und Integrationsstandards über alle Module.',
    'Owns security governance and cyber control framework.': 'Verantwortet Security-Governance und das Cyber-Control-Framework.',
    'Owns enterprise data governance across all platform domains.': 'Verantwortet die unternehmensweite Data-Governance über alle Plattformdomänen.',
    'Owns cross-module user experience and journey consistency.': 'Verantwortet modulübergreifende User Experience und Journey-Konsistenz.',
    'Coordinates cross-module delivery scope and shared capabilities.': 'Koordiniert modulübergreifenden Delivery-Scope und gemeinsame Fähigkeiten.',
    'Owns distribution architecture and broker-facing operating model.': 'Verantwortet Distributionsarchitektur und das brokerseitige Operating Model.',
    'Owns claims workflow architecture and claims experience design.': 'Verantwortet Claims-Workflow-Architektur und das Claims-Experience-Design.',
    'Owns AI feature integration into operational modules.': 'Verantwortet die Integration von AI-Features in operative Module.',
    'Owns broker operating model and distribution processes.': 'Verantwortet das Broker-Operating-Model und die Distributionsprozesse.',
    'Controls AI risk governance and model assurance.': 'Steuert AI-Risikogovernance und Model-Assurance.',
    'Supervises regulatory and operational compliance.': 'Überwacht regulatorische und operative Compliance.',
    'Manages treaty architecture and ceded risk strategy.': 'Steuert Treaty-Architektur und die Strategie für zedierte Risiken.',
    'Ensures data protection by design and by default.': 'Stellt Datenschutz durch Design und per Default sicher.',
    'Business logic authority for platform strategy and portfolio direction.': 'Fachliche Autorität für Plattformstrategie und Portfoliorichtung.',
    'Technical authority for architecture, cloud infrastructure, and security baselines.': 'Technische Autorität für Architektur, Cloud-Infrastruktur und Sicherheits-Baselines.',
    'Engineering quality gates and delivery model decisions.': 'Entscheidet über Engineering-Qualitäts-Gates und das Delivery-Modell.',
    'Architecture standards and cross-domain design approvals.': 'Entscheidet über Architekturstandards und domänenübergreifende Designfreigaben.',
    'Security standard enforcement and major security escalation decisions.': 'Durchsetzung von Sicherheitsstandards und Entscheidungen bei kritischen Security-Eskalationen.',
    'Data model and quality-policy governance decisions.': 'Entscheidungen zur Data-Model-Governance und zu Qualitätsrichtlinien.',
    'Experience standards and journey quality requirements.': 'Entscheidungen zu Experience-Standards und Anforderungen an Journey-Qualität.',
    'Cross-module release scope and shared feature sequencing.': 'Entscheidet über modulübergreifenden Release-Scope und die Reihenfolge gemeinsamer Features.',
    'Brokerportal release scope and distribution workflow requirements.': 'Entscheidet über Brokerportal-Release-Scope und Anforderungen an Distributionsworkflows.',
    'Claims-domain release scope and process architecture priorities.': 'Entscheidet über Release-Scope im Claims-Bereich und Prioritäten der Prozessarchitektur.',
    'AI feature integration scope and rollout sequencing.': 'Entscheidet über Integrationsscope und Rollout-Reihenfolge von AI-Features.',
    'Owns global platform administration and tenant lifecycle.': 'Verantwortet die globale Plattformadministration und den Mandantenlebenszyklus.',
    'Leads claims operating model and leakage controls.': 'Leitet das Claims-Operating-Model und die Leakage-Kontrollen.',
    'Defines MGA underwriting framework and authority design.': 'Definiert das MGA-Underwriting-Framework und das Authority-Design.',
    'Owns reliability, deployment architecture, and runtime operations.': 'Verantwortet Zuverlässigkeit, Deployment-Architektur und Laufzeitbetrieb.',
    'Administers broker tenant users and operating setup.': 'Administriert Benutzer und Betriebs-Setup des Maklermandanten.',
    'Prepares risk submissions and supports market placement quality.': 'Bereitet Risikosubmissions auf und unterstützt die Platzierungsqualität im Markt.',
    'Coordinates client-side claims oversight.': 'Koordiniert die kundenseitige Claims-Überwachung.',
    'Owns portfolio relationship and growth strategy for assigned clients.': 'Verantwortet Kundenbeziehungen und Wachstumsstrategie für zugeordnete Accounts.',
    'Manages commission visibility and broker financial controls.': 'Steuert Provisions-Transparenz und finanzielle Kontrollen im Maklerbereich.',
    'Executes delegated underwriting decisions within authority band.': 'Trifft delegierte Underwriting-Entscheidungen innerhalb des Authority-Bands.',
    'Handles complex or escalated underwriting cases.': 'Bearbeitet komplexe oder eskalierte Underwriting-Fälle.',
    'Steers portfolio performance against appetite and margin goals.': 'Steuert die Portfolio-Performance entlang Risikobereitschaft und Margenzielen.',
    'Maintains pricing assumptions and actuarial calibration.': 'Pflegt Pricing-Annahmen und aktuarielle Kalibrierung.',
    'Coordinates capacity allocation and treaty alignment.': 'Koordiniert Kapazitätsallokation und Treaty-Abstimmung.',
    'Administers tenant-internal user and module governance.': 'Administriert mandanteninterne User- und Modul-Governance.',
    'Owns regional fleet operations and risk controls.': 'Verantwortet regionale Flottenoperationen und Risikokontrollen.',
    'Manages corporate claims process and escalation.': 'Steuert den Claims-Prozess und Eskalationen auf Unternehmensebene.',
    'Coordinates risk prevention and insurance control framework.': 'Koordiniert Risikoprävention und das versicherungsbezogene Kontrollframework.',
    'Controls premium, invoice, and settlement finance flows.': 'Steuert Finanzflüsse für Prämien, Rechnungen und Settlements.',
    'Manages warehouse and goods-handling risk operations.': 'Steuert Risikoprozesse in Lager und Warenhandling.',
    'Executes transport operations and primary FNOL input.': 'Führt Transportprozesse aus und liefert den primären FNOL-Input.',
    'Plans routes and load operations with risk awareness.': 'Plant Routen und Ladevorgänge mit Risikofokus.',
    'Monitors policy adherence for people and process compliance.': 'Überwacht Richtlinientreue für Personen- und Prozess-Compliance.',
    'Primary operational claim processor.': 'Primäre operative Rolle in der Schadenbearbeitung.',
    'Independent damage assessment specialist.': 'Unabhängige Fachrolle für Schadenbegutachtung.',
    'Performs repair services and cost estimates.': 'Erbringt Reparaturleistungen und erstellt Kostenschätzungen.',
    'Provides replacement vehicle continuity services.': 'Stellt Ersatzmobilität zur Sicherung der Betriebsfortführung bereit.',
    'Handles towing, recovery, and transport assistance.': 'Übernimmt Abschleppung, Bergung und Transportassistenz.',
    'Manages salvage valuation and disposal channels.': 'Steuert Restwertbewertung und Verwertungswege.',
    'Pursues recovery from liable third parties.': 'Verfolgt Regress gegenüber haftenden Dritten.',
    'Provides legal strategy for disputed claims.': 'Liefert Rechtsstrategie für strittige Schadenfälle.',
    'Performs forensic investigation for suspicious events.': 'Führt forensische Untersuchungen bei Verdachtsfällen durch.',
    'Operates fraud detection review and intervention.': 'Steuert die Prüfung und Intervention bei Betrugsverdacht.',
    'Reviews carrier-risk view and delegated authority outcomes.': 'Prüft die Risikosicht des Versicherers und Ergebnisse delegierter Befugnisse.',
    'Supervises claim quality for carrier-exposed portfolios.': 'Überwacht die Schadenqualität in versichererseitig exponierten Portfolios.',
    'Monitors ceded impact and exposure accumulation.': 'Überwacht Auswirkungen zedierter Risiken und Akkumulationen.',
    'Approves or adjusts capacity commitments.': 'Gibt Kapazitätszusagen frei oder passt sie an.',
    'Controls treaty performance and structure fitness.': 'Steuert Treaty-Performance und strukturelle Eignung.',
    'Evaluates profitability and risk trend assumptions.': 'Bewertet Profitabilität und Annahmen zu Risikotrends.',
    'Monitors capital stress and concentration risk.': 'Überwacht Kapitalstress und Konzentrationsrisiken.',
    'Ensures financial integrity of premium and claims flows.': 'Sichert die finanzielle Integrität von Prämien- und Schadenflüssen.',
    'Owns business accountability for production AI models.': 'Verantwortet die fachliche Ergebnisverantwortung für produktive AI-Modelle.',
    'Develops and validates predictive model logic.': 'Entwickelt und validiert prädiktive Modelllogik.',
    'Operates ML pipelines and production deployment reliability.': 'Betreibt ML-Pipelines und die Zuverlässigkeit produktiver Deployments.',
    'Connects analytics outcomes to underwriting and claims strategy.': 'Verknüpft Analyseergebnisse mit Underwriting- und Claims-Strategie.',
    'Validates AI control compliance and traceability.': 'Validiert AI-Control-Compliance und Nachvollziehbarkeit.',
    'Final underwriting policy and override rights for delegated lines.': 'Finale Underwriting-Richtlinienkompetenz und Override-Rechte für delegierte Linien.',
    'Claims policy decisions and high-severity approval thresholds.': 'Entscheidungen zu Claims-Richtlinien und Freigabeschwellen für hohe Schadenhöhen.',
    'Broker experience standards and distribution operations decisions.': 'Entscheidet über Broker-Experience-Standards und Distributionsprozesse.',
    'AI go-live/freeze decisions and mandatory human override rules.': 'Entscheidet über AI-Go-live/-Freeze und verbindliche Human-Override-Regeln.',
    'Compliance exceptions, control escalations, audit response coordination.': 'Entscheidet über Compliance-Ausnahmen, Kontrolleskalationen und Audit-Reaktion.',
    'Treaty and facultative placement recommendations for approval.': 'Empfehlungen zur Genehmigung von Treaty- und fakultativen Platzierungen.',
    'Deployment gates, rollback decisions, operational risk mitigation.': 'Entscheidet über Deployment-Gates, Rollbacks und operative Risikominderung.',
    'Privacy control approval and data access escalation decisions.': 'Entscheidet über Datenschutzkontrollen und Eskalationen bei Datenzugriffen.',
    'Broker-internal access grants and process settings.': 'Entscheidet über maklerinterne Zugriffsfreigaben und Prozesseinstellungen.',
    'Submission readiness and market-routing proposals.': 'Entscheidet über Submission-Reife und Vorschläge zur Marktsteuerung.',
    'Escalation initiation and client-side settlement coordination.': 'Entscheidet über Eskalationsstart und kundenseitige Settlement-Koordination.',
    'Offer selection recommendations and renewal negotiation strategy.': 'Empfehlungen zur Angebotsauswahl und Strategie für Renewal-Verhandlungen.',
    'Broker financial validation and exception escalation.': 'Entscheidet über finanzielle Makler-Validierung und Ausnahmeeskalation.',
    'Accept/decline/referral within defined underwriting authority.': 'Annahme/Ablehnung/Referral innerhalb der definierten Underwriting-Befugnis.',
    'Escalated case decisions and authority exceptions.': 'Entscheidet über eskalierte Fälle und Authority-Ausnahmen.',
    'Portfolio steering actions and risk appetite adjustments (proposed).': 'Steuerungsmaßnahmen im Portfolio und vorgeschlagene Anpassungen der Risikobereitschaft.',
    'Pricing parameter recommendations and model-calibration sign-off.': 'Empfehlungen zu Pricing-Parametern und Freigabe der Modellkalibrierung.',
    'Capacity allocation proposals and referral escalations to carrier.': 'Vorschläge zur Kapazitätsallokation und Referral-Eskalationen an den Versicherer.',
    'Client-internal access decisions and permission delegation.': 'Entscheidet über mandanteninterne Zugriffe und Delegation von Berechtigungen.',
    'Operational actions for assigned regional fleet scope.': 'Entscheidet über operative Maßnahmen im zugewiesenen regionalen Flottenscope.',
    'Escalation and evidence completion decisions.': 'Entscheidet über Eskalation und Vervollständigung von Nachweisen.',
    'Internal risk-control actions and prevention priorities.': 'Entscheidet über interne Risikokontrollmaßnahmen und Präventionsprioritäten.',
    'Financial validation and exception escalation.': 'Entscheidet über finanzielle Validierung und Ausnahmeeskalation.',
    'Operational safety actions in warehouse domain.': 'Entscheidet über operative Sicherheitsmaßnahmen im Lagerbereich.',
    'Can submit own incidents; no pricing/policy governance rights.': 'Kann eigene Vorfälle melden; keine Rechte in Pricing- oder Richtlinien-Governance.',
    'Operational route decisions within planning mandate.': 'Entscheidet über operative Routen innerhalb des Planungsmandats.',
    'Internal compliance escalation and control recommendations.': 'Entscheidet über interne Compliance-Eskalation und Kontrollempfehlungen.',
    'Operational claim-handling decisions within authority.': 'Operative Entscheidungen in der Schadenbearbeitung innerhalb der Befugnis.',
    'Assessment opinion; no final settlement authority.': 'Gibt Begutachtungsvotum ab; keine finale Settlement-Befugnis.',
    'Repair feasibility and estimate confirmation.': 'Entscheidet über Reparaturfähigkeit und bestätigt Schätzungen.',
    'Can confirm rental costs; cannot approve settlement.': 'Kann Mietkosten bestätigen; kann kein Settlement freigeben.',
    'Operational recovery completion decisions.': 'Entscheidet über den operativen Abschluss von Bergungen.',
    'Salvage bid and value recommendations.': 'Empfehlungen zu Restwertgeboten und Wertermittlung.',
    'Recovery-path recommendation and legal escalation input.': 'Empfehlungen zum Regresspfad und Input für juristische Eskalation.',
    'Legal recommendation authority; final settlement per claims governance.': 'Juristische Empfehlungsbefugnis; finales Settlement gemäß Claims-Governance.',
    'Forensic conclusion, no direct settlement control.': 'Forensische Schlussfolgerung, keine direkte Settlement-Steuerung.',
    'Fraud investigation escalation and hold recommendation.': 'Empfehlung zur Eskalation von Betrugsprüfungen und zur Fallsperre.',
    'Approval/decline on carrier referral thresholds.': 'Freigabe/Ablehnung bei Referral-Schwellen des Versicherers.',
    'Claims governance decisions above contractual threshold.': 'Claims-Governance-Entscheidungen oberhalb vertraglicher Schwellenwerte.',
    'Analytical recommendation for capacity/treaty adjustments.': 'Analytische Empfehlung für Kapazitäts-/Treaty-Anpassungen.',
    'Formal capacity approval within carrier governance.': 'Formale Kapazitätsfreigabe innerhalb der Carrier-Governance.',
    'Treaty structure recommendations and trigger escalations.': 'Empfehlungen zur Treaty-Struktur und Trigger-Eskalationen.',
    'Actuarial recommendation authority for pricing updates.': 'Aktuarielle Empfehlungsbefugnis für Pricing-Updates.',
    'Risk-limit escalation recommendations.': 'Empfehlungen zur Eskalation von Risikolimits.',
    'Financial control sign-off and exception escalation.': 'Freigabe finanzieller Kontrollen und Ausnahmeeskalation.',
    'Model release/freeze recommendation with governance board.': 'Empfehlung zu Model-Release/-Freeze im Governance-Board.',
    'Technical model recommendation authority.': 'Technische Empfehlungsbefugnis für Modelle.',
    'Technical deployment and rollback decisions.': 'Technische Entscheidungen zu Deployment und Rollback.',
    'Analytical steering recommendations for management.': 'Analytische Steuerungsempfehlungen für das Management.',
    'Audit findings and remediation escalation rights.': 'Befugnis zu Auditfeststellungen und Eskalation von Maßnahmen.'
  }

  if (sentenceMap[value]) return sentenceMap[value]

  let translated = value
  const phraseReplacements: Array<[string, string]> = [
    ['System-wide', 'Systemweit'],
    ['Cross-module', 'Modulübergreifend'],
    ['cross-module', 'modulübergreifend'],
    ['cross-domain', 'domänenübergreifend'],
    ['cross-tenant', 'mandantenübergreifend'],
    ['break-glass', 'Break-Glass'],
    ['by design and by default', 'durch Design und per Default'],
    ['technical authority', 'technische Autorität'],
    ['business authority', 'fachliche Autorität'],
  ...
  const wordReplacements: Array<[RegExp, string]> = [
    [/\bOwns\b/g, 'Verantwortet'],
    [/\bLeads\b/g, 'Leitet'],
    [/\bDefines\b/g, 'Definiert'],
    [/\bEnsures\b/g, 'Stellt sicher'],
    [/\bManages\b/g, 'Steuert'],
    [/\bMonitors\b/g, 'Überwacht'],
    [/\bCoordinates\b/g, 'Koordiniert'],
    [/\bExecutes\b/g, 'Führt aus'],
    [/\bReviews\b/g, 'Prüft'],
    [/\bControls\b/g, 'Steuert'],
    [/\bProvides\b/g, 'Stellt bereit'],
    [/\bSupports\b/g, 'Unterstützt'],
    [/\bsupports\b/g, 'unterstützt'],
    [/\bgovernance\b/g, 'Governance'],
    [/\bunderwriting\b/g, 'Underwriting'],
    [/\bClaims\b/g, 'Schaden'],
    [/\bclaims\b/g, 'schaden'],
    [/\brisk\b/g, 'Risiko'],
    [/\bportfolio\b/g, 'Portfolio'],
    [/\brenewal\b/g, 'Erneuerung'],
    [/\bpermissions\b/g, 'Berechtigungen'],
    [/\bdecisions\b/g, 'Entscheidungen'],
    [/\bdecision\b/g, 'Entscheidung'],
    [/\bapprovals\b/g, 'Freigaben'],
    [/\bapproval\b/g, 'Freigabe'],
    [/\bescalations\b/g, 'Eskalationen'],
    [/\bescalation\b/g, 'Eskalation'],
    [/\bevidence\b/g, 'Nachweise'],
    [/\breporting\b/g, 'Reporting'],
    [/\bmodels\b/g, 'Modelle'],
    [/\bmodel\b/g, 'Modell'],
    [/\bcompliance\b/g, 'Compliance'],
    [/\bpolicies\b/g, 'Richtlinien'],
    [/\bpolicy\b/g, 'Richtlinie'],
    [/\bclients\b/g, 'Kunden'],
    [/\bclient\b/g, 'Kunde'],
    [/\bfinancial\b/g, 'finanzielle'],
    [/\banalytics\b/g, 'Analysen'],
    [/\bworkflow\b/g, 'Workflow'],
    [/\bworkflows\b/g, 'Workflows'],
    [/\bquality\b/g, 'Qualität'],
    [/\bservice\b/g, 'Service'],
    [/\bcapacity\b/g, 'Kapazität'],
    [/\btemporary\b/g, 'temporär'],
    [/\bassignment\b/g, 'Zuweisung'],
    [/\bassigned\b/g, 'zugewiesen'],
    [/\bPrimary\b/g, 'Primär'],
    [/\bno\b/g, 'keine']
  ]
  wordReplacements.forEach(([regex, to]) => {
