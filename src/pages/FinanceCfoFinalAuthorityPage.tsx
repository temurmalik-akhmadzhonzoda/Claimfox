...
export default function FinanceCfoFinalAuthorityPage() {
  ...
  const copy = lang === 'en'
    ? {
        ...
        subtitle: 'Final approvals, governance and carrier finance authority.',
        ...
        snapshot: {
          ...
          risks: 'Governance and audit risks',
        ...
        audit: {
          ...
          indicators: ['Mandatory sign-offs completed', 'Override reason present', 'Financial scope confirmed']
        },
        authorityNote: 'Carrier retains final finance authority at all times.',
        footer: {
    ...
    : {
        title: 'CFO / Carrier Finance Final Authority — Finance Dashboard',
        subtitle: 'Finale Freigaben, Governance und Carrier-Finance-Authority.',
        ...
        snapshot: {
          ...
          risks: 'Governance- und Audit-Risiken',
        ...
        audit: {
          ...
          indicators: ['Mandatory Sign-offs abgeschlossen', 'Override-Begründung vorhanden', 'Financial-Scope bestätigt']
        },
        authorityNote: 'Carrier behält jederzeit die finale Finance Authority.',
        footer: {
  ...
  const cases: FinanceCase[] = [
    {
      id: 'CF-201',
      type: 'Approval',
      trigger: 'Capital allocation exception',
      severity: 'High',
      slaDue: '2026-01-27T16:55:00Z',
      slaBucket: 'due_today',
      recommendation: 'Final approve',
      status: 'In review',
      applicableRules: ['Capital Governance v4.1', 'Authority Matrix'],
      keyRisks: ['Capital strain', 'Governance override'],
      evidenceQuality: 91,
      escalationRequired: true,
      summary: 'Exception requires CFO sign-off with carrier authority.'
    },
    {
      id: 'CF-206',
      type: 'Approval',
      trigger: 'Reserve adjustment above threshold',
      severity: 'Medium',
      slaDue: '2026-01-28T12:35:00Z',
      slaBucket: 'due_48h',
      recommendation: 'Approve with conditions',
      status: 'Open',
      applicableRules: ['Reserve Policy v3.4', 'Approval Matrix'],
      keyRisks: ['Budget impact', 'Audit trail completeness'],
      evidenceQuality: 84,
      escalationRequired: false,
      summary: 'Adjustment within threshold, conditions required.'
    },
    {
      id: 'CF-213',
      type: 'Approval',
      trigger: 'Governance breach identified',
      severity: 'High',
      slaDue: '2026-01-27T09:55:00Z',
      slaBucket: 'breached',
      recommendation: 'Decline',
      status: 'Breached',
      applicableRules: ['Governance Policy v4.1', 'Audit SOP'],
      keyRisks: ['Compliance exposure', 'Audit exception'],
      evidenceQuality: 62,
      escalationRequired: true,
      summary: 'Governance breach triggers decline recommendation.'
    }
  ]

  const logs: LogEntry[] = [
    { timestamp: '2026-01-27 10:40', role: 'CFO', action: 'Final review', ruleVersion: 'v4.1', evidenceStatus: 'ok', note: 'Approval pending' },
    { timestamp: '2026-01-27 09:18', role: 'Finance Controller', action: 'Recommendation submitted', ruleVersion: 'v3.4', evidenceStatus: 'ok', note: 'Conditions attached' },
    { timestamp: '2026-01-26 17:50', role: 'Compliance', action: 'Audit check', ruleVersion: 'v4.1', evidenceStatus: 'stale', note: 'Missing annex' },
    { timestamp: '2026-01-26 12:58', role: 'CFO', action: 'Escalation flagged', ruleVersion: 'v4.1', evidenceStatus: 'missing', note: 'Governance breach' },
    { timestamp: '2026-01-25 16:40', role: 'Finance Controller', action: 'Evidence request', ruleVersion: 'v3.4', evidenceStatus: 'ok', note: 'Reserve memo' }
  ]
      ...
      <div className="uw-container">
        ...
        <div className="uw-grid uw-split">
          <Card title={copy.table.title} variant="glass" className="uw-card" style={{ overflowX: 'auto' }}>
            <table className="uw-table" aria-label="CFO decision inbox">
              <thead>
                <tr>
                  <th>{copy.table.id}</th>
        ...
        <div className="uw-grid uw-triplet">
          ...
          <Card title={copy.audit.title} variant="glass" className="uw-card">
            ...
            <div style={{ overflowX: 'auto' }}>
              <table className="uw-table" aria-label="CFO audit log">
                <thead>
                  <tr>
