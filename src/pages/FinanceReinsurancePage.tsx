...
export default function FinanceReinsurancePage() {
  ...
  const copy = lang === 'en'
    ? {
        ...
        subtitle: 'Cessions, bordereaux and recoveries oversight.',
        lastUpdated: 'Last updated: 27 Jan 2026, 15:15',
        kpi: {
          open: 'Open reinsurance cases',
          dueToday: 'Decisions due today',
          breaches: 'SLA breaches',
          cycle: 'Avg processing cycle',
          escalations: 'Escalations pending',
          recoveries: 'Recoveries rate %'
        },
        table: {
        ...
        snapshot: {
          ...
          summary: 'Cession summary',
          risks: 'Recovery risks',
          rules: 'Applicable reinsurance terms',
          aiTitle: 'AI-generated decision template — requires human validation',
          templates: 'Decision templates'
        },
        actions: {
          approve: 'Approve cession',
          reconcile: 'Reconcile bordereaux',
          escalate: 'Escalate to Reinsurance Lead'
        },
        slaPanel: {
        ...
        audit: {
          ...
          indicators: ['Mandatory sign-offs completed', 'Override reason present', 'Reinsurance scope confirmed']
        },
        footer: {
    ...
    : {
        title: 'Reinsurance Finance — Finance Dashboard',
        subtitle: 'Cessions, Bordereaux und Recoveries-Überwachung.',
        lastUpdated: 'Zuletzt aktualisiert: 27. Jan 2026, 15:15',
        kpi: {
          open: 'Offene Reinsurance Cases',
          dueToday: 'Entscheidungen heute fällig',
          breaches: 'SLA Breaches',
          cycle: 'Ø Verarbeitungszyklus',
          escalations: 'Eskalationen pending',
          recoveries: 'Recoveries-Quote %'
        },
        table: {
          title: 'Decision Inbox',
          id: 'Case ID',
        ...
        snapshot: {
          title: 'Decision Snapshot',
          summary: 'Cession Summary',
          risks: 'Recovery-Risiken',
          rules: 'Anwendbare Rückversicherungsbedingungen',
          aiTitle: 'AI-Decision-Template — Human Validation erforderlich',
          templates: 'Entscheidungsvorlagen'
        },
        actions: {
          approve: 'Cession freigeben',
          reconcile: 'Bordereaux abgleichen',
          escalate: 'An Reinsurance Lead eskalieren'
        },
        slaPanel: {
          title: 'SLA & Governance',
          buckets: 'SLA Buckets',
        ...
        audit: {
          ...
          indicators: ['Mandatory Sign-offs abgeschlossen', 'Override-Begründung vorhanden', 'Reinsurance-Scope bestätigt']
        },
        footer: {
  ...
  const cases: FinanceCase[] = [
    {
      id: 'RI-701',
      type: 'Cession',
      trigger: 'Quota share allocation',
      severity: 'Medium',
      slaDue: '2026-01-27T16:50:00Z',
      slaBucket: 'due_today',
      recommendation: 'Approve cession',
      status: 'In review',
      applicableRules: ['Reinsurance Treaty v4.0', 'Cession Policy v2.2'],
      keyRisks: ['Treaty limits', 'Data completeness'],
      evidenceQuality: 82,
      escalationRequired: false,
      summary: 'Quota share allocation requires confirmation.'
    },
    {
      id: 'RI-708',
      type: 'Bordereaux',
      trigger: 'Bordereaux mismatch',
      severity: 'High',
      slaDue: '2026-01-28T12:20:00Z',
      slaBucket: 'due_48h',
      recommendation: 'Reconcile bordereaux',
      status: 'Open',
      applicableRules: ['Bordereaux SOP v1.5', 'Treaty Reporting Guidelines'],
      keyRisks: ['Recoveries delay', 'Reporting accuracy'],
      evidenceQuality: 76,
      escalationRequired: true,
      summary: 'Mismatch in ceded premium requires reconciliation.'
    },
    {
      id: 'RI-713',
      type: 'Recoveries',
      trigger: 'Late recovery notice',
      severity: 'High',
      slaDue: '2026-01-27T09:40:00Z',
      slaBucket: 'breached',
      recommendation: 'Escalate to Reinsurance Lead',
      status: 'Breached',
      applicableRules: ['Recoveries Policy v3.1', 'Treaty Compliance'],
      keyRisks: ['Recovery loss', 'Audit exception'],
      evidenceQuality: 60,
      escalationRequired: true,
      summary: 'Recovery notice delayed; escalation required.'
    }
  ]

  const logs: LogEntry[] = [
    { timestamp: '2026-01-27 10:20', role: 'Reinsurance Finance', action: 'Cession review', ruleVersion: 'v2.2', evidenceStatus: 'ok', note: 'Approved' },
    { timestamp: '2026-01-27 09:05', role: 'Reinsurance Finance', action: 'Bordereaux check', ruleVersion: 'v1.5', evidenceStatus: 'stale', note: 'Mismatch flagged' },
    { timestamp: '2026-01-26 17:18', role: 'Reinsurance Lead', action: 'Escalation review', ruleVersion: 'v3.1', evidenceStatus: 'missing', note: 'Recovery notice' },
    { timestamp: '2026-01-26 12:35', role: 'Reinsurance Finance', action: 'Evidence request', ruleVersion: 'v1.5', evidenceStatus: 'missing', note: 'Schedule update' },
    { timestamp: '2026-01-25 16:22', role: 'Compliance', action: 'Audit check', ruleVersion: 'v3.1', evidenceStatus: 'ok', note: 'No issues' }
  ]
      ...
      <div className="uw-container">
        ...
        <div className="uw-grid uw-split">
          <Card title={copy.table.title} variant="glass" className="uw-card" style={{ overflowX: 'auto' }}>
            <table className="uw-table" aria-label="Reinsurance finance decision inbox">
              <thead>
                <tr>
                  <th>{copy.table.id}</th>
            ...
            <div className="uw-card-body" style={{ gap: '0.75rem' }}>
              ...
              <div>
                ...
                <div className="uw-actions">
                  ...
                  <Button variant="secondary" onClick={() => {}}>{copy.actions.reconcile}</Button>
        ...
        <div className="uw-grid uw-triplet">
          ...
          <Card title={copy.audit.title} variant="glass" className="uw-card">
            ...
            <div style={{ overflowX: 'auto' }}>
              <table className="uw-table" aria-label="Reinsurance finance audit log">
                <thead>
                  <tr>
