  ...
  return (
    <section className="page" style={{ gap: '1.5rem' }}>
      <div style={{ width: '100%', maxWidth: 980, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        <Header title={t('profile.overview.sections.locations')} subtitle={t('profile.placeholders.locations')} subtitleColor="#65748b" />
        <Card>
          <p style={{ margin: 0, color: '#475569' }}>{t('profile.placeholders.locations')}</p>
